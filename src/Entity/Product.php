...
class Product
{
     ...
     * @Assert\NotBlank(message="La photo principale doit être une URL")
     */
    private $mainPicture;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="La champ description courte est obligatoire")
     * @Assert\Length(min=3, max=225, minMessage="Le nom doit contenir au moins 3 caractère")
     */
    ...
    //         new Assert\Length(['min' => 3, 'max' => 255, 'minMessage' => "Le nom du produit doit contenir au mois 3 caractères"])
    //     ]);
